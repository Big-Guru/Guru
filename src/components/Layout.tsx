      ...
      <aside className={cn(
        ...
        <div className="p-4 border-t border-slate-100 bg-slate-50/30 flex flex-col gap-3">
          <button 
            ...
            className="hidden lg:flex items-center justify-center w-full p-2 rounded-xl text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-colors bg-white border border-slate-200/60 shadow-sm"
          >
